    ...
    <div class="container">
        <!-- Jumbotron Header -->
            <div class="jumbotron home-spacer" id="products-jumbotron">
                <center><h1>Welcome to our FusionStore'99</h1>
                <p>We have the best Shoes from Biggest Brands for you. No need to hunt around, we have all in one place.</p>
              </center>
            </div>
            <hr>
            <br>
            ...
            <div class="col-sm-12 text-center">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="boot" style="color:#47cbff">Boots</h3>
                        </div>
                    
                    <div class="panel-body">
                        <div class="col-sm-3 home-feature">
                            <div class="thumbnail">
                                <img src="./img/b1.jpg" alt="boot" >
                                    <div class="caption">
                                        <h3>Monster Boot</h3>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="formals" style="color:#47cbff">Formals</h3>
                        </div>
                    
                    <div class="panel-body">
                        <div class="col-sm-3 home-feature">
                            <div class="thumbnail">
                                <img src="./img/brf.jpg" alt="" >
                                    <div class="caption">
                                        <h3>Brown Formals</h3>
                   ...
                   <!----------------------------------------------------sneakers----------------------------------->
                <div class="panel panel-default">
                        <div class="panel-he3ding  color">
                            <h3 id="sneakers" style="color:#47cbff">Sneakers</h3>
                        </div>
                                ...
                                <div class="caption">
                                    <h3>SUCCI Snake</h3>
                                        <p>Price: Rs. 9999.00 </p>
                                            ...
                                            ?>
                                            <a href="cart-add.php?id=9" name="add" value="add" class="btn btn-block btn-info">Add to cart</a>
                                            <?php
                                                }
                                            }
                                        ?>
                   ...
                   <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="sports" style="color:#47cbff">Sports Shoes</h3>
                        </div>
